...
object EnvironmentUtils {
    ...
    fun isEmulatorOrCloud(context: Context): Boolean {
        ...
        Log.d(TAG, "Environment check - Brand: $brand, Device: $device, Model: $model, Product: $product, Hardware: $hardware, Fingerprint: $fingerprint, Manufacturer: $manufacturer, Board: $board -> isEmulatorOrCloud: $isEmulator")
        return isEmulator
    }
}
